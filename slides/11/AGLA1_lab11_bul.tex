...
\begin{frame}[t]{Task 1, Var 1 (previous year)}
...
\begin{frame}[t]{Task 2, Var 1 (previous year)}
...
\begin{frame}[t]{Task 3, Var 1 (previous year)}
...
\begin{frame}[t]{Task 4, Var 1 (previous year)}
...
\begin{frame}[t]{Engineers in math class be like}
    \framesubtitle{Video}
    \vspace{-0.6cm}
    \begin{figure}[H]
        \href{https://youtu.be/F_OkdTTcO6o?si=-i8DlvqOMRBmHMs4}{
            \centering\includegraphics[height=6cm,width=1\textwidth,keepaspectratio]{video1.jpg}}
        \label{fig:video1.jpg}
    \end{figure}
\end{frame}
