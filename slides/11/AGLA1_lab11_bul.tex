...
\note{\scriptsize \begin{itemize}
    ...
    \item До 2ого слайда просишь студентов самим напистаь все формы на доске, потом показываешь
    \item Projection transformation у них не будет, но чтобы научились головой думать
    \item Показать что разница между аффиным и сменой базиса только в концепте, что базис мы меняем обычно только повротом у ортогональной истории. А так по факту это одно и тоже
