...
\begin{frame}[t]{Task 2}
    \framesubtitle{}
    \only<1>{Transform $x^2-xy+y^2+x+y=0$ into pure canoncial form}
    \only<2>{
        \alert{\Large Answer}
        \begin{figure}[H]
