...
\begin{figure}[H]
    ...
    \end{subfigure}
    \begin{subfigure}[t]{0.32\textwidth}
        \uncover<4->{\centering\includegraphics[height=2.3cm,width=1\textwidth,keepaspectratio]{1_3.png}}
...
\vspace{-0.3cm}
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        \uncover<5->{\centering\includegraphics[height=2.3cm,width=1\textwidth,keepaspectratio]{1_4.png}}
        \caption{$-3x^2+2y^2-z^2=1$ \\ \uncover<5->{Hyperboloid of two sheets}}
        \label{fig:1_4.png}
    \end{subfigure}
    \begin{subfigure}[t]{0.32\textwidth}
        \uncover<6->{\centering\includegraphics[height=2.3cm,width=1\textwidth,keepaspectratio]{1_5.png}}
        \caption{$2x^2+3y-z=0$ \\ \uncover<6->{Parabolic cylinder}}
        \label{fig:1_5.png}
    \end{subfigure}
    \begin{subfigure}[t]{0.32\textwidth}
        \uncover<7->{\centering\includegraphics[height=2.3cm,width=1\textwidth,keepaspectratio]{1_6.png}}
