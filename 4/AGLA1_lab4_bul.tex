...
\subtitle{Inverse Matrix \\ Matrix Rank \\ Change of basis   
         } %% title page.
...
\end{frame}
\note{Добавить типо подводку к остальному}
...
\frame[plain,label={change_of_basis_gorodetskii}]{}

\usebackgroundtemplate{}
\setbeamercolor{background canvas}{bg=}
\includepdf[pages=-,fitpaper]{change_of_basis_gorodetskii.pdf}
\fbckg{fibeamer/figs/common.png}
