...
% \end{enumerate} 
\item (5 points) 
Find the equation of an ellipse (major axis is horizontal), if it is known that the eccentricity equals $0.5$ and the distance from its focus to the nearest vertex is 2.
...
\item (5 points)
In a triangle $\bigtriangleup ABC$ have vertices with coordinates $A(2,0); B(-1,2), C(-1,-2)$. 
